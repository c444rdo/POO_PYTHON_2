...
# Ejemplo de uso:
cuenta = Cuenta("Juan Perez", 1000)
cuenta.mostrar()  # Muestra: Titular: Juan Perez, Cantidad: 1000
cuenta.ingresar(500)  # Ingresa 500.
cuenta.mostrar()  # Muestra: Titular: Juan Perez, Cantidad: 1500
cuenta.retirar(200)  # Retira 200.
cuenta.mostrar()  # Muestra: Titular: Juan Perez, Cantidad: 1300